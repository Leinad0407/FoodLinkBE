...
export default function Home () {
  ...
  <Carousel.Item>
    ...
    <Carousel.Caption>
      ...
      <p class="caption-car">Rescatamos alimento en tu ciudad, mientras evitamos el desperdicio.</p>
    </Carousel.Caption>
  </Carousel.Item>
  <Carousel.Item>
    <img
...
<div className="text-container">
  <h4>Comparte, evita el desperdicio y ayuda al planeta.
   <br /> La mejor app de donacion de comida</h4>
</div>
...
<Card style={{ width: '25rem'}}>
      ...
      <Card.Body>
        ...
        <Card.Text>
        Con un click, tú puedes donar el alimento que necesitan para sobrevivir. Sólo toma unos segundos apoyar con tu donación. 
        </Card.Text>
        <Button className= "btn-donador" variant="primary">¿Donar Comida?</Button>
      </Card.Body>
    </Card>
    ...
    <Card style={{ width: '25rem' }}>
      ...
      <Card.Body>
        ...
        <Card.Text>
        Puedes buscar alimentos que necesitas,
        Sólo toma unos segundos darte de alta y encontrar lugares con donaciones.
        </Card.Text>
        <Button className= "btn-buscador" variant="primary">¿Buscas Comida?</Button>
      </Card.Body>
    </Card>
